...
class JournalEntryRow extends DataClass implements Insertable<JournalEntryRow> {
  ...
  /// Millis since epoch, per the spec's INTEGER columns.
  final int createdAt;
  final int updatedAt;
  ...
  @override
  int get hashCode =>
      Object.hash(id, date, title, content, createdAt, updatedAt);
  @override
...
abstract class _$StillDatabase extends GeneratedDatabase {
  _$StillDatabase(QueryExecutor e) : super(e);
  $StillDatabaseManager get managers => $StillDatabaseManager(this);
...
class $$JournalEntriesTableFilterComposer
    extends Composer<_$StillDatabase, $JournalEntriesTable> {
...
typedef $$JournalEntriesTableProcessedTableManager =
    ProcessedTableManager<
      ...
      (
        JournalEntryRow,
        BaseReferences<_$StillDatabase, $JournalEntriesTable, JournalEntryRow>,
      ),
      JournalEntryRow,
      PrefetchHooks Function()
    >;

class $StillDatabaseManager {
  final _$StillDatabase _db;
  $StillDatabaseManager(this._db);
